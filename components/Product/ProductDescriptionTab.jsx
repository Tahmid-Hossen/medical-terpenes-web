...
const ProductDescriptionTab = ({product, singleProduct}) => {
  // console.log("Product description", singleProduct[0])
  return (
        ...
        >
          ...
          <Nav.Item>
            <Nav.Link eventKey="reviews">
              REVIEWS {product?.ratingCount ? `(${product?.ratingCount || 3})` : ""}
            </Nav.Link>
          </Nav.Item>
        </Nav>
        <Tab.Content>
          <Tab.Pane eventKey="description">
            <div className="product-description-tab__details">
              <div
                dangerouslySetInnerHTML={{__html: singleProduct?.fullDescription ?? ''}}
              />
            </div>
          </Tab.Pane>
            ...
            <div className="product-description-tab__review">
              <div className="comments">
                <h5 className="product-tab-title">
                  {product?.ratingCount} Review For <span>{singleProduct?.name}</span>
                </h5>
                <ul className="list-none comment-list mt-4">
                  <li>
                    <div className="comment-img">
                      <Image width={100} height={100} src="/assets/images/users/user1.jpg" alt="user1"/>
                    </div>
                  ...
                  <li>
                    <div className="comment-img">
                      <Image width={100} height={100} src="/assets/images/users/user2.jpg" alt="user2"/>
                    </div>
                    <div className="comment-block">
                      <div className="rating-wrap">
                        <div className="rating">
